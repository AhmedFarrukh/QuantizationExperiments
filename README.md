...
The discrepancy in results can be explained by the use of different quantization methods, frameworks and hardware environments; in "Performance evaluation of INT8 quantized inference on mobile GPUs", inference time speedup is shown to vary depending on aforementioned factors, supporting this explanation<sup>[5]</sup>.  
